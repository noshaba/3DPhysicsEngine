...
int main() {
	...
	// init_scene();
	// Cuboid* cub = new Cuboid(Vec3(-1,-1,-1),Vec3(1,1,1),1,0, new Vec3(1,0,0), Vec3(-10,0,1));
	// Sphere* sph = new Sphere(1,Vec3(5,0,0),1,0, new Vec3(1,0,0), Vec3(-10,1,1));
	// sph->set_ang_velocity(Vec3(0,5,0));
	// game->add_cuboid(cub);
